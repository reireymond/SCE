...
void verDetalhesProdutoraView(Sistema *sistema) {
    ...
    // Imprime um cabeçalho para a listagem dos dados.
    printf("\n--- Detalhes da Produtora Cadastrada ---\n");
    // Imprime cada campo da estrutura 'Produtora' com um rótulo descritivo.
    ...
    // Para o float, '%.2f' formata o número para exibir duas casas decimais.
